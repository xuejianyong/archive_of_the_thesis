...
datafile = os.path.join(scriptPath,'result_maze_optimize_svg-2_abstract_2020107_1027.txt')
print datafile
...
plt.annotate('The moment that the environment has been changed',xy=(500,-0.3),xytext=(600,-1),arrowprops = dict(facecolor='red',shrink=0.05,headlength= 10,headwidth = 10))
plt.xlabel('Decision cycles')
