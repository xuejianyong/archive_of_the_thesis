...
datafile = os.path.join(scriptPath,'result_maze_optimize_svg-2_abstract_2020108_230.txt')
print datafile
...
plt.annotate('The moment that the environment has been changed',xy=(500,27),xytext=(550,20),arrowprops = dict(facecolor='red',shrink=0.05,headlength= 10,headwidth = 10))
...
plt.annotate('The moment that the \n environment has been changed',xy=(500,-138),xytext=(200,50),arrowprops = dict(facecolor='red',shrink=0.05,headlength= 10,headwidth = 10))
plt.xlabel('Decision cycles')
...
plt.figure()
plt.title("Average aaavalence with decision cycles from agent's interactions with the environment.")
plt.plot(loopNumList,averageTotalValenceList,label="Average valence with decision cycles.")
plt.annotate('The moment that the environment has been changed',xy=(500,-0.3),xytext=(600,-2),arrowprops = dict(facecolor='red',shrink=0.05,headlength= 10,headwidth = 10))
plt.xlabel('Decision cycles')
...
#plt.annotate('The moment that the environment has been changed',xy=(500,-138),xytext=(600,-200),arrowprops = dict(facecolor='red',shrink=0.05,headlength= 10,headwidth = 10))
plt.xlabel('Decision cycles')
...
plt.annotate('The moment that the environment has been changed',xy=(500,719),xytext=(550,600),arrowprops = dict(facecolor='red',shrink=0.05,headlength= 10,headwidth = 10))
plt.xlabel('Decision cycles')
