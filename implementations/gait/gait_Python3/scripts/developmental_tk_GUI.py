...
def learnCompositeInteraction(currentEnactedInteraction):
    ...
    if previousEnactedInteraction != None:
        # the point                                                                                  #current enacted interaction
...
def initial():
    #creation of all six experiemnts (actions)
    ...
    #creation 10 of primitive interactions (experiments with result, and valences)
    i01 = addOrGetPrimitiveInteraction(e0, 1, v_moveSucess); #isHall = false
    i00 = addOrGetPrimitiveInteraction(e0, 0, v_moveFailture); #isHall =true
    i11 = addOrGetPrimitiveInteraction(e1, 1, v_turn); #default isHall = true
...
def interaction(canvas,count):
    ...
    if startState:
        ...
        while loopNum < 200:
            ...
            intendedInteraction = sortedAnticipations[0].experiment.intendedInteraction # the one has the biggest proclivity
