...
datafile = os.path.join(scriptPath,'result_maze_optimize_svg-2_abstract_2020108_133.txt')
print datafile
...
plt.annotate('The moment that the \n environment has been changed',xy=(500,27),xytext=(550,20),arrowprops = dict(facecolor='red',shrink=0.05,headlength= 10,headwidth = 10))
...
plt.annotate('The moment that the \n environment has been changed',xy=(500,-138),xytext=(250,250),arrowprops = dict(facecolor='red',shrink=0.05,headlength= 10,headwidth = 10))
plt.xlabel('Decision cycles')
...
plt.annotate('The moment that the \n environment has been changed',xy=(500,-0.3),xytext=(550,-2),arrowprops = dict(facecolor='red',shrink=0.05,headlength= 10,headwidth = 10))
plt.xlabel('Decision cycles')
...
plt.annotate('The moment that the \n environment has been changed',xy=(500,719),xytext=(550,600),arrowprops = dict(facecolor='red',shrink=0.05,headlength= 10,headwidth = 10))
plt.xlabel('Decision cycles')
